...
class Tiles:
    ...
    def get_mine_count(self):
        fill(0)
        textSize(32)
        text(str(self.mines - sum(t.state_flag == tile.FLAG for t in self.tile_list)), width/16, height/16 - 12)
        fill(220, 220, 200)
    ...
    def click(self, x, y, mb):
        ...
        if mb == LEFT and self.tile_list[location].state_flag != tile.CLICKED:
